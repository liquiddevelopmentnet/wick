...
export class WickParser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
		WickParser._LITERAL_NAMES,
		WickParser._SYMBOLIC_NAMES,
		[]
	)
	...
	public get grammarFileName(): string {
		return 'WickParser.g4'
	}

	// @Override
	public get ruleNames(): string[] {
		return WickParser.ruleNames
	}

	// @Override
	public get serializedATN(): string {
		return WickParser._serializedATN
	}
	...
	public schemaBlock(): SchemaBlockContext {
		let _localctx: SchemaBlockContext = new SchemaBlockContext(
			this._ctx,
			this.state
		)
	...
	public schemaStatement(): SchemaStatementContext {
		let _localctx: SchemaStatementContext = new SchemaStatementContext(
			this._ctx,
			this.state
		)
	...
	public schemaField(): SchemaFieldContext {
		let _localctx: SchemaFieldContext = new SchemaFieldContext(
			this._ctx,
			this.state
		)
	...
	public schemaScopedBlock(): SchemaScopedBlockContext {
		let _localctx: SchemaScopedBlockContext = new SchemaScopedBlockContext(
			this._ctx,
			this.state
		)
	...
	public schemaType(): SchemaTypeContext {
		let _localctx: SchemaTypeContext = new SchemaTypeContext(
			this._ctx,
			this.state
		)
	...
	public quotelessArgument(): QuotelessArgumentContext {
		let _localctx: QuotelessArgumentContext = new QuotelessArgumentContext(
			this._ctx,
			this.state
		)
	...
	public number_int(): Number_intContext {
		let _localctx: Number_intContext = new Number_intContext(
			this._ctx,
			this.state
		)
	...
	public number_double(): Number_doubleContext {
		let _localctx: Number_doubleContext = new Number_doubleContext(
			this._ctx,
			this.state
		)
		...
		try {
			this.enterOuterAlt(_localctx, 1)
			{
				...
				while (
					(_la & ~0x1f) === 0 &&
					((1 << _la) &
						((1 << WickParser.StringLiteral) |
							(1 << WickParser.IntegerLiteral) |
							(1 << WickParser.DoubleLiteral) |
							(1 << WickParser.BooleanLiteral) |
							(1 << WickParser.GenericLiteral) |
							(1 << WickParser.VARIABLE_PREFIX))) !==
						0
				) {
					{
						{
	...
	public scopedBlock(): ScopedBlockContext {
		let _localctx: ScopedBlockContext = new ScopedBlockContext(
			this._ctx,
			this.state
		)
	...
	public static readonly _serializedATN: string =
		'\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x14\xB1\x04\x02' +
		...
		'\x13\x0E\x13\x99\v\x13\x03\x13\x03\x13\x03\x14\x03\x14\x07\x14\x9F\n\x14' +
		'\f\x14\x0E\x14\xA2\v\x14\x03\x14\x07\x14\xA5\n\x14\f\x14\x0E\x14\xA8\v' +
		'\x14\x03\x14\x03\x14\x07\x14\xAC\n\x14\f\x14\x0E\x14\xAF\v\x14\x03\x14' +
		'\x04e\x97\x02\x02\x15\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02' +
		'\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A\x02\x1C\x02\x1E\x02 \x
		"\xAE\x03\x02\x02\x02\xAE'\x03\x02\x02\x02\xAF\xAD\x03\x02\x02\x02\x14" +
		').8?ELQV^ens\x8A\x90\x97\xA0\xA6\xAD'
	public static __ATN: ATN
	public static get _ATN(): ATN {
		if (!WickParser.__ATN) {
			WickParser.__ATN = new ATNDeserializer().deserialize(
				Utils.toCharArray(WickParser._serializedATN)
			)
		}
...
export class CompilationUnitContext extends ParserRuleContext {
	public EOF(): TerminalNode {
		return this.getToken(WickParser.EOF, 0)
	}
	...
	public get ruleIndex(): number {
		return WickParser.RULE_compilationUnit
	}
	// @Override
...
export class SchemaContext extends ParserRuleContext {
	public SchemaPrefix(): TerminalNode {
		return this.getToken(WickParser.SchemaPrefix, 0)
	}
	public schemaBlock(): SchemaBlockContext {
...
export class SchemaBlockContext extends ParserRuleContext {
	public LBRACE(): TerminalNode {
		return this.getToken(WickParser.LBRACE, 0)
	}
	public RBRACE(): TerminalNode {
		return this.getToken(WickParser.RBRACE, 0)
	}
	public NL(): TerminalNode[]
	public NL(i: number): TerminalNode
	public NL(i?: number): TerminalNode | TerminalNode[] {
	...
	public schemaStatement(
		i?: number
	): SchemaStatementContext | SchemaStatementContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_schemaBlock
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class SchemaStatementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_schemaStatement
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class SchemaFieldContext extends ParserRuleContext {
	...
	public SchemaTypeToken(): TerminalNode {
		return this.getToken(WickParser.SchemaTypeToken, 0)
	}
	public schemaType(): SchemaTypeContext[]
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_schemaField
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class SchemaScopedBlockContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_schemaScopedBlock
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class SchemaTypeContext extends ParserRuleContext {
	public SchemaTypeLiteral(): TerminalNode {
		return this.getToken(WickParser.SchemaTypeLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_schemaType
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class StatementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_statement
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class IdContext extends ParserRuleContext {
	public GenericLiteral(): TerminalNode {
		return this.getToken(WickParser.GenericLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
...
export class QuotelessArgumentContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_quotelessArgument
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class StrContext extends ParserRuleContext {
	public StringLiteral(): TerminalNode {
		return this.getToken(WickParser.StringLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
...
export class Number_intContext extends ParserRuleContext {
	public IntegerLiteral(): TerminalNode {
		return this.getToken(WickParser.IntegerLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_number_int
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class Number_doubleContext extends ParserRuleContext {
	public DoubleLiteral(): TerminalNode {
		return this.getToken(WickParser.DoubleLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_number_double
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class BoolContext extends ParserRuleContext {
	public BooleanLiteral(): TerminalNode {
		return this.getToken(WickParser.BooleanLiteral, 0)
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState)
	}
...
export class VariableContext extends ParserRuleContext {
	public VARIABLE_PREFIX(): TerminalNode {
		return this.getToken(WickParser.VARIABLE_PREFIX, 0)
	}
	public id(): IdContext {
		return this.getRuleContext(0, IdContext)
	}
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_variable
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class ArgumentContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_argument
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
...
export class ScopedBlockContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number {
		return WickParser.RULE_scopedBlock
	}
	// @Override
	public enterRule(listener: WickParserListener): void {
